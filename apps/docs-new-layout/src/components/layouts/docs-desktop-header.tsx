 ...
 */
export function DocsDesktopHeader({ githubStars }: { githubStars: number }) {
	return (
        ...
        <Link
					...
					<div className="w-full max-w-48">
						<button
							type="button"
							className="flex h-9 w-full items-center justify-between border border-transparent bg-white px-4 py-2 align-middle text-base-500 text-xs leading-tight placeholder-base-400 shadow-sm ring-1 ring-base-200 transition duration-300 ease-in-out focus:z-10 focus:border-accent-500 focus:outline-none focus:ring-2 focus:ring-accent-100 focus:ring-offset-white dark:bg-base-900 dark:ring-base-800 dark:focus:ring-offset-base-900"
 ...
 *
 * Provides clean toggle between:
 * - Light mode
 * - Dark mode
 *
 * @returns The theme switcher JSX element
 */
		...
		<div className="grid w-[120px] grid-cols-2 overflow-hidden rounded-none border border-base-300 dark:border-base-700">
			...
			<button
				...
				className={`flex items-center justify-center px-2 py-2 transition-colors ${
					theme === 'light'
						? 'bg-base-200 text-base-900 dark:bg-base-800 dark:text-white'
						: 'bg-white text-base-500 hover:bg-base-100 hover:text-base-900 dark:bg-base-900 dark:text-base-400 dark:hover:bg-base-800 dark:hover:text-white'
				}`}
