...
Carry the policy contract through the shared runtime, Astro and SvelteKit. Hydrate stored records on runtime start, preserve server-prepared records, and leave lifecycle ownership with the runtime when framework components borrow it.
