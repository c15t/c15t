...
Follow focus inside shadow roots when trapping Tab navigation and restoring the opener. Release overlapping scroll locks only after the last surface closes.
