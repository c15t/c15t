...
<p align="center">
  <a href="https://www.youtube.com/watch?v=XtuBNb_qsjI" target="_blank" rel="noopener noreferrer">
    <img src="https://img.youtube.com/vi/XtuBNb_qsjI/maxresdefault.jpg" 
         alt="Why Your Consent Banner Should Be in Your Bundle – Next.js Conf 2025" 
         width="720">
  </a>
</p>

<p align="center">
  <b>▶️ Watch the Next.js Conf 2025 Talk: “Why Your Consent Banner Should Be in Your Bundle”</b><br>
  <a href="https://c15t.link/talk">https://c15t.link/talk</a>
</p>
...
|---------|-------------|--------------|---------|
| `c15t` | Lightweight, Framework-Agnostic Consent Management | Developer-First Design, Works across JavaScript frameworks, GDPR Compliance, Customizable Consent Management, Server-Side Rendering Support, Internationalization | [![npm](https://img.shields.io/npm/v/c15t?style=flat-square)](https://www.npmjs.com/package/c15t) |
...
| `@c15t/scripts` | Prebuilt Scripts | Prebuilt script snippets for popular analytics and marketing tools, Easy integration with c15t's script loader, Configuration options for each supported vendor, Supports Google Tag Manager, Google Tag (GA4 + Google Ads), Ahrefs Analytics, Cloudflare Web Analytics, Microsoft Clarity, Databuddy, Fathom Analytics, Hotjar, Matomo Analytics, PostHog, Segment, Rybbit Analytics, Plausible Analytics, Umami Analytics, Vercel Analytics, Meta Pixel, Reddit Pixel, Snapchat Pixel, TikTok Pixel, LinkedIn Insights, Microsoft UET, and X Pixel | [![npm](https://img.shields.io/npm/v/@c15t/scripts?style=flat-square)](https://www.npmjs.com/package/@c15t/scripts) |
| `@c15t/scripts` | Prebuilt Scripts | Prebuilt script snippets for popular analytics and marketing tools, Easy integration with c15t's script loader, Configuration options for each supported vendor, Supports Google Tag Manager, Google Tag (GA4 + Google Ads), Ahrefs Analytics, Cloudflare Web Analytics, Microsoft Clarity, Databuddy, Fathom Analytics, Hotjar, Matomo Analytics, Mixpanel Analytics, PostHog, Segment, Rybbit Analytics, Plausible Analytics, Umami Analytics, Vercel Analytics, Meta Pixel, Reddit Pixel, Snapchat Pixel, TikTok Pixel, LinkedIn Insights, Microsoft UET, and X Pixel | [![npm](https://img.shields.io/npm/v/@c15t/scripts?style=flat-square)](https://www.npmjs.com/package/@c15t/scripts) |
