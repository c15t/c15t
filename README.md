...
| `@c15t/scripts` | Prebuilt Scripts | Prebuilt script snippets for popular analytics, marketing, and functional tools, Easy integration with c15t's script loader, Configuration options for each supported vendor, Supports Google Tag Manager, Google Tag (GA4 + Google Ads), Ahrefs Analytics, Cloudflare Web Analytics, Microsoft Clarity, Databuddy, Fathom Analytics, Hotjar, Matomo Analytics, Mixpanel Analytics, PostHog, Promptwatch, Segment, Rybbit Analytics, Plausible Analytics, Umami Analytics, Vercel Analytics, Crisp, Intercom, Meta Pixel, Reddit Pixel, Snapchat Pixel, TikTok Pixel, LinkedIn Insights, Microsoft UET, and X Pixel | [![npm](https://img.shields.io/npm/v/@c15t/scripts?style=flat-square)](https://www.npmjs.com/package/@c15t/scripts) |
