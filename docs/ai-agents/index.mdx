...
Every supported scoped c15t package ships docs inside the installed package itself. Installing the `c15t` umbrella gives you `node_modules/c15t/AGENTS.md` as the index, plus the scoped packages' full doc bundles — the umbrella installs those packages for you.
