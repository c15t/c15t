...
The scoped packages you integrate directly — `@c15t/core`, `@c15t/react`, `@c15t/nextjs`, `@c15t/scripts`, and `@c15t/cli` — ship docs inside the installed package itself. Installing the `c15t` umbrella gives you `node_modules/c15t/AGENTS.md` as the index plus the doc bundles of the packages it installs for you: `@c15t/core`, `@c15t/react`, and `@c15t/nextjs`.

### Where to find them

With the `c15t` umbrella installed:

- `node_modules/c15t/AGENTS.md` — the umbrella's index into the scoped bundles below
- `node_modules/@c15t/core/docs/README.md`
- `node_modules/@c15t/react/docs/README.md`
- `node_modules/@c15t/nextjs/docs/README.md`

`@c15t/scripts` and `@c15t/cli` bundle their own docs when you install them directly:

- `node_modules/@c15t/scripts/docs/README.md`
- `node_modules/@c15t/cli/docs/README.md`

Start with the package `README.md`, then follow its linked pages for the relevant workflow.

Supporting packages such as `@c15t/backend`, `@c15t/iab`, `@c15t/node-sdk`, `@c15t/schema`, and `@c15t/translations` publish only their built output — for those, point your agent at [c15t.com/docs](https://c15t.com/docs) instead.
...
- Copy changes -> `ConsentProvider.options.i18n`
