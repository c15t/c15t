...
GVL caching is separate from manifest HTTP caching. Supply a cache adapter with
your server-side GVL configuration. Concurrent misses share an in-flight fetch,
