...
<AutoTypeTable path="./packages/backend/src/types/index.ts" name="BaseOptions" />

<AutoTypeTable path="./packages/backend/src/types/index.ts" name="DatabaseOptions" />

## Advanced Options

<AutoTypeTable path="./packages/backend/src/types/index.ts" name="AdvancedOptions" />
