...
`x-c15t-vendors` is optional and native-app shaped: a comma-separated list of
the vendor ids an application actually ships. On a matched IAB rule the `gvl` in
