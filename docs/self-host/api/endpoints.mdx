...
```json
{
  "subject": { "id": "sub_abc123", "isIdentified": false, "...": "..." },
...
{
  "subjects": [
    { "id": "sub_abc123", "externalId": "user_12345", "isIdentified": true }
  ]
}
```

<Callout type="warn">
This endpoint requires API key authentication. Configure API keys in the `advanced.apiKeys` option. The key is passed via the `Authorization: Bearer` header using timing-safe comparison.
</Callout>
