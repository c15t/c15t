...
Keep the manifest setup from the [App Router](/docs/frameworks/next/app-router)
or [Pages Router](/docs/frameworks/next/pages-router) guide. Put vendor callbacks
...
unlisted vendor and [verification](/docs/guides/verify-consent) for the network
