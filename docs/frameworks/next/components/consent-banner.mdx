...
Keep the boundary and URL configuration from your
[App Router setup](/docs/frameworks/next/app-router). Render one banner inside
its existing consent boundary. Keep the global stylesheet from that setup,
