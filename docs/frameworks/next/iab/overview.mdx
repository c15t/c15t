...
```tsx
import { IABProvider, IABConsentBanner, IABConsentDialog } from '@c15t/nextjs/iab';
...
Import `@c15t/nextjs/iab/styles.css` at your global stylesheet entry. Supply the CMP ID
