...
<Steps>
  ...
  <Step>
    ...
    <Callout type="info">
      Don't have a backend yet? Use `mode: 'offline'` to get started with local-only consent storage. See [Client Modes](/docs/frameworks/next/concepts/client-modes) for details.
    </Callout>
  </Step>
