---
title: Quickstart (App Directory)
description: Integrate c15t into your Next.js app directory application with this step-by-step guide. We'll cover installation, configuration, and basic usage.
