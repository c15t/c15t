...
- [Hosted c15t](/docs/frameworks/javascript/storing-consent/hosted-c15t) - Use consent.io for a managed solution
- [Self-Hosting](/docs/frameworks/javascript/storing-consent/self-hosting) - Run your own c15t instance
- [Offline Mode](/docs/frameworks/javascript/storing-consent/offline-mode) - Store consent in the browser
