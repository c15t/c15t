...
<div className="mt-6">
  <CompactCard href="/docs/frameworks/javascript/storing-consent/hosted-c15t" icon={<RiGlobalLine size={18} />}>
    Use <code>Hosted c15t</code>
  </CompactCard>

  <CompactCard href="/docs/frameworks/javascript/storing-consent/offline-mode" icon={<RiTimerLine size={18} />}>
