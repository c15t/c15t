...
<Callout type="note">
  Offline mode provides the same API as the standard client, but operates entirely client-side.
</Callout>
...
<div className="mt-6">
  <CompactCard href="/docs/frameworks/javascript/storing-consent/self-hosting" icon={<RiServerLine size={18} />}>
