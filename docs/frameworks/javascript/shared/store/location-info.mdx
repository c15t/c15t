...
The `locationInfo` property stores the user's location information. Used for determining the jurisdiction of the user, like if they should see a EU GDPR banner or not.
