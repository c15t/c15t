...
<AutoTypeTable path="./packages/core/src/index.ts" name="ConsentType" />
...
<AutoTypeTable path="./packages/core/src/index.ts" name="TrackingBlockerConfig" />

## Additional Types

### Consent State
<AutoTypeTable path="./packages/core/src/index.ts" name="ConsentState" />

### Compliance Settings
<AutoTypeTable path="./packages/core/src/index.ts" name="ComplianceSettings" />

### Privacy Settings
<AutoTypeTable path="./packages/core/src/index.ts" name="PrivacySettings" />

### Translation Types
<AutoTypeTable path="./packages/core/src/index.ts" name="TranslationConfig" />
<AutoTypeTable path="./packages/translations/src/index.ts" name="Translations" />
