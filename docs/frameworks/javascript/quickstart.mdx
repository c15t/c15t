...
- [Hosted c15t](/docs/frameworks/javascript/storing-consent/hosted) - Complete guide to using consent.io
- [Offline Mode](/docs/frameworks/javascript/storing-consent/offline) - Complete guide to using c15t without a backend
