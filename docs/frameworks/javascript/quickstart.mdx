...
availableIn:
  - framework: 'react'
    ...
    title: 'React'
  - framework: 'next'
    url: '/docs/frameworks/next/quickstart/app'
    title: 'Next.js'
---
...
<Cards>
  <Card variant="compact" href="/docs/frameworks/javascript/storing-consent/hosted-c15t" icon={<Icon name="flashlight" size={16} />}>
    Learn more about <code>Hosted c15t (consent.io)</code>
  </Card>

  <Card variant="compact" href="/docs/frameworks/javascript/storing-consent/self-hosting" icon={<Icon name="server" size={16} />}>
    Learn more about <code>Self-Hosting</code>
  </Card>

  <Card variant="compact" href="/docs/frameworks/javascript/storing-consent/offline-mode" icon={<Icon name="wifi-offline" size={16} />}>
