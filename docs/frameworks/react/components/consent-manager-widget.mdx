...
import { CookieIcon, LayersIcon } from 'lucide-react';
...
<Cards>
  <Card icon={<CookieIcon />} title="Cookie Banner" description="The friendly first-touch privacy notice that greets users. Customizable, accessible, and designed to get out of the way." href="/docs/components/react/cookie-banner" />
