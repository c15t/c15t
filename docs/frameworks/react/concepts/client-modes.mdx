...
import { hosted, ConsentProvider, ConsentBanner } from 'c15t/react';
...
```tsx
import { type ReactNode } from 'react';
import { offline, ConsentProvider, ConsentBanner } from 'c15t/react';
...
```tsx
import { type ReactNode } from 'react';
import { custom, ConsentProvider, ConsentBanner } from 'c15t/react';
