...
<Steps>
  <Step>
    ...
    <PackageCommandTabs command="@c15t/react" mode="install" />
...
<Callout type="note">
  Offline mode provides the same API interface as the standard client but
...
<Callout type="warning">
  Some browser environments like private browsing modes may have localStorage
  restrictions.
</Callout>
...
<Callout type="tip">
  Offline mode is an excellent choice for static sites deployed on platforms
  like Vercel, Netlify, or GitHub Pages.
</Callout>
...
<Callout type="important">
  Understand these limitations when deciding if offline mode is right for your
  application.
</Callout>
...
<div className="mt-6">
  <CompactCard href="/docs/storing-consent/self-hosting" icon={<RiServerLine size={18} />}>
