...
<AutoTypeTable path="./packages/core/src/client/types.ts" name="ResponseContext" />
...
<AutoTypeTable path="./packages/core/src/client/client-interface.ts" name="ConsentVerifiedCallbackPayload" />
