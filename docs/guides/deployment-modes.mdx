...
forwarded headers under the backend's usual IP handling. Static output resolves
in the browser and sends none. Set `reportSessions: false` on an adapter to turn
it off.
