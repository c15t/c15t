...
By default, GTM is loaded when the 'necessary' category is given consent, as it controls the loading of other scripts.
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={['JavaScript', 'React', 'Next.js + App Router', 'Next.js + Pages Router']}>
      ...
      <Tab value="React">
      ```tsx
      import { googleTagManager } from '@c15t/react/scripts/google-tag-manager';
...
<AutoTypeTable path="./packages/core/src/scripts/google-tag-manager.ts" name="GoogleTagManagerOptions" />
