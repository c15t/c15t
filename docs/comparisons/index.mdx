...
| Next.js App Router support with SSR or prefetching                            | c15t                                                                                                                                                                                                                                                                                                      | `c15t/next` supports App Router setup, same-origin rewrites, `C15tPrefetch`, and `prefetchInitialConsent()`.           |
...
with `prefetchInitialConsent()` and `ConsentBoundary`.
