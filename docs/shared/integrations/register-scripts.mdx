...
<Tabs items={['Next.js', 'TanStack Start', 'React', 'Nuxt', 'Vue', 'Astro', 'Svelte', 'SvelteKit', 'JavaScript', 'React Native']}>
  <Tab value="Next.js">
  ...
  <Tab value="TanStack Start">
    ...
    `ConsentRoot`. Keep the server loader from the [TanStack Start quickstart](/docs/frameworks/tanstack-start/quickstart).
  ...
  <Tab value="React Native">
    ...
    [React Native setup](/docs/frameworks/react-native/quickstart).
  </Tab>
</Tabs>
