...
<section id="intro-and-setup">
  ...
  Keep Tailwind's directives in your app stylesheet, but wrap `@tailwind base` in a native `base` layer so c15t's emitted `@layer components` rules sit above Preflight while utilities stay last:
