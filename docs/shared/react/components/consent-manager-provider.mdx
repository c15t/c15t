...
<section id="policy-packs">
  ...
  - `offlinePolicy.i18n` lets offline mode mirror hosted `messageProfile` and `fallbackLanguage` behavior.
  - Omitting `offlinePolicy.policyPacks` uses the built-in synthetic opt-in fallback banner.
