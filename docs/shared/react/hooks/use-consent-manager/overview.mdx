...
<section id="state-and-actions">
  ...
  Use the narrow action hooks such as `useSetConsent`, `useSaveConsents`,
  `useSetOverrides`, and `useIdentify` to update the kernel.
</section>
...
<section id="key-types">
  ...
  <details>
    ...
    interface ConsentInfo {
      ...
      externalId?: string;             // External user ID linked via identify()
