...
| Next.js App Router support with SSR or prefetching                            | c15t                                                                                                                                                                                                                                                                                                      | `c15t/next` supports App Router setup, same-origin rewrites, `C15tPrefetch`, and `fetchInitialData()`.                  |
...
| Next.js and App Router fit                   | 🟢 `c15t/next`                 | 🟡 Client-only setup       | 🟡 Client-only setup       | 🟡 Client-only setup            | 🟡 Client-only setup     | 🟡 Hosted script                    | 🟡 Hosted script                | 🟡 Client component     |
...
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Consent model                       | CMP-style modes through policy packs, using `opt-in`, `opt-out`, and `iab`, with separate choice, notice or none prompts.                                                             | Client-side categories and services for banner and preference UI.                                   | Services and purposes, with stored choices and app controls.            | Service catalog and tag-manager-style consent.                           | Client-side consent types with script injection and Google mapping.             | Dashboards, regional templates, consent receipts, rules, and privacy-team workflows.                                | One banner decision stored by the React component.    |
...
Use c15t when React should own consent state through `ConsentProvider`,
...
code, or same-origin backend routing. `c15t/next` supports client-only setup,
