...
- [Hosted C15t](/docs/nextjs/storing-consent/hosted-c15t) - Complete guide to using consent.io
- [Offline Mode](/docs/nextjs/storing-consent/offline-mode) - Complete guide to using c15t without a backend
- [Custom Client](/docs/nextjs/storing-consent/custom-client) - Advanced implementation with custom handlers for full control
