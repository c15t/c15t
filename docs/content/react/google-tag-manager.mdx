---
title: Google Tag Manager Setup (Beta)
...
<Callout type="note">
This step is optional if you already have a Tag Manager container. Ensure your container is set to "Consent Mode".
</Callout>
...
All you need to do copy and paste your container ID into the `googleTagManager.id` property.
