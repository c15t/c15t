...
- [Server-Based Storage](/nextjs/storing-consent/server-based-storage) - Learn about the built-in server storage option
- [Offline Mode](/nextjs/storing-consent/offline-mode) - Explore browser-based storage 