...
- [Self-Hosting Guide](/nextjs/storing-consent/self-hosting) - Run your own c15t instance
- [Offline Mode](/nextjs/storing-consent/offline-mode) - Use browser-based storage without a server
- [Custom Client](/nextjs/storing-consent/custom-client) - Implement your own storage solution