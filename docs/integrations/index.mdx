...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Microsoft UET" description="Track conversions and measure performance for Microsoft Advertising and Bing Ads." icon={<Icon name="microsoft" />} href="/docs/integrations/microsoft-uet" />
