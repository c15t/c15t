...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="YouTube Embed" description="Efficiently load YouTube videos with a lightweight alternative that loads only when users interact." icon={<Icon name="youtube" />} href="/docs/integrations/youtube-embed" />
</Cards>
