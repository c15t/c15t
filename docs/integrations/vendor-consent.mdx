...
Add `vendors` to your provider or runtime options. Each vendor sits inside a
category condition and needs a name and a privacy policy URL so the preference
surface can list it:
