...
<Steps>
  ...
  <Step>
    ...
    The recommended PostHog SDK approach uses two phases: run one initial sync after c15t has finished resolving consent, then subscribe to effective permission changes with `permissions:changed`.
