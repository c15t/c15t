...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Google reCAPTCHA" description="Load the reCAPTCHA loader with your site key in the script URL." icon={<Icon name="guide" />} href="/docs/integrations/google-recaptcha" />
