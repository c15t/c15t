...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Lemon Squeezy" description="Load Lemon.js for checkout buttons and Lemon Squeezy embeds." icon={<Icon name="guide" />} href="/docs/integrations/lemon-squeezy" />
