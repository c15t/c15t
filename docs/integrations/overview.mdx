...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Hotjar" description="Understand behavior with heatmaps, session recordings, and feedback tools behind measurement consent." icon={<Icon name="guide" />} href="/docs/integrations/hotjar" />
