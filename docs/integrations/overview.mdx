...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Usercentrics" description="Load the Usercentrics CMP v3 loader with your ruleset id." icon={<Icon name="guide" />} href="/docs/integrations/usercentrics" />
