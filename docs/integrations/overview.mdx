...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Google AdSense" description="Load Google AdSense with a declarative publisher client configuration." icon={<Icon name="guide" />} href="/docs/integrations/google-adsense" />
