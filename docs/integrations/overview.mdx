...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="PayPal" description="Load the PayPal Web SDK core bundle for live or sandbox environments." icon={<Icon name="guide" />} href="/docs/integrations/paypal" />
