...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Segment" description="Collect analytics events once and forward them to downstream destinations with measurement consent gating." icon={<Icon name="guide" />} href="/docs/integrations/segment" />
