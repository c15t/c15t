...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Matomo Analytics" description="Self-hosted or cloud analytics with queue-based tracking and optional consent-mode commands." icon={<Icon name="guide" />} href="/docs/integrations/matomo-analytics" />
  ...
  <Card variant="interactive" title="Promptwatch" description="Artificial Intelligence (AI)-focused website analytics loaded with a project-id script attribute." icon={<Icon name="guide" />} href="/docs/integrations/promptwatch" />
...
Functional integrations usually require `functionality` consent. They add optional user-facing capabilities, such as scheduling widgets, that should only run after the user allows them.

<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  <Card variant="interactive" title="Calendly" description="Load the Calendly widget bundle and queue API calls before the script arrives." icon={<Icon name="guide" />} href="/docs/integrations/calendly" />
</Cards>
