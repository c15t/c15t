...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="npm CDN" description="Load an npm package entry from a public CDN with a resolved script URL." icon={<Icon name="guide" />} href="/docs/integrations/npm" />
