...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Mixpanel Analytics" description="Track product usage with a helper that syncs Mixpanel's opt-in and opt-out APIs to measurement consent." icon={<Icon name="guide" />} href="/docs/integrations/mixpanel-analytics" />
