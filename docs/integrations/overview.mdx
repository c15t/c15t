...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Reddit Pixel" description="Track conversions and build retargeting audiences for Reddit advertising campaigns." icon={<Icon name="reddit" />} href="/docs/integrations/reddit-pixel" />
