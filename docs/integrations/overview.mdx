...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Vimeo Player" description="Load the Vimeo Player API for embedded video controls." icon={<Icon name="guide" />} href="/docs/integrations/vimeo-player" />
