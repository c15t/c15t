...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Front Chat" description="Load Front Chat after functionality consent and initialize the widget when its SDK is ready." href="/docs/integrations/front-chat" />
