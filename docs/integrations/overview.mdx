...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Pinterest Tag" description="Track conversions and build audiences for Pinterest advertising campaigns." icon={<Icon name="pinterest" />} href="/docs/integrations/pinterest-tag" />
</Cards>
