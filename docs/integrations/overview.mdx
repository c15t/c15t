...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Google Sign-In" description="Load Google Identity Services for sign-in flows in your application code." icon={<Icon name="guide" />} href="/docs/integrations/google-sign-in" />
