...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Matomo Analytics" description="Run self-hosted or cloud Matomo tracking with consent-aware queueing." icon={<Icon name="guide" />} href="/docs/integrations/matomo-analytics" />
