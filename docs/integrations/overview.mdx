...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="YouTube Player" description="Load the YouTube iframe API and a readiness callback stub." icon={<Icon name="guide" />} href="/docs/integrations/youtube-player" />
