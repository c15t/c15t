...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Microsoft Clarity" description="Session replay and heatmap analytics with queue stubs and consent-state synchronization." icon={<Icon name="microsoft-clarity" />} href="/docs/integrations/clarity" />
  ...
  <Card variant="interactive" title="Umami Analytics" description="Open-source, cookieless analytics configured entirely through script data attributes." icon={<Icon name="umani-analytics" />} href="/docs/integrations/umami-analytics" />
...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Intercom" description="Bootstrap Intercom settings and load the messenger widget bundle." icon={<Icon name="guide" />} href="/docs/integrations/intercom" />
</Cards>
