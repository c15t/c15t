...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Mixpanel Analytics" description="Product analytics with always-on loading and consent toggled via Mixpanel opt-in and opt-out APIs." icon={<Icon name="guide" />} href="/docs/integrations/mixpanel-analytics" />
