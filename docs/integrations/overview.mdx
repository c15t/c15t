...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="OneDollarStats" description="Load website analytics after measurement consent, with no API key required." href="/docs/integrations/one-dollar-stats" />
