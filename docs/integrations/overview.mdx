...
<Cards className="my-10 grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 @container not-prose grid gap-4">
  ...
  <Card variant="interactive" title="Databuddy"
 ...
 description="Privacy-focused analytics with automatic consent management and cookieless tracking support." icon={<Icon name="databuddy" />} href="/docs/integrations/databuddy" />
