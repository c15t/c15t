...
For v3, source code and installed documentation determine the migration work. The legacy codemod collection targets v2, apart from the named `use-consent-manager-to-hooks` transform. It does not update dependencies, convert a v2 backend configuration to v3, or migrate a database.
