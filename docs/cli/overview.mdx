...
description: Use the CLI for initial setup, migrations and project workflows, then verify the generated integration.
group: cli
---
...
Use [manual framework setup](/docs/frameworks) when you want to control
each file explicitly.

Start new integrations with [Inth](/docs/guides/inth). The CLI can help create the
...
automation. See [CLI quickstart](/docs/cli/quickstart).
...
[the v3 migration guide](/docs/upgrade-v3) and verify the resulting application.
