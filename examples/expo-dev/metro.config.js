...
/**
 * Expo's defaults, before anything here is layered on.
 */
 ...
 *
 * `expo/metro-config` does not re-export Metro's `mergeConfig`, so the three fields
 * that need to combine are combined here. Everything else Expo set stays as it is.
 *
...
module.exports = {
	...
	resolver: {
		...
		extraNodeModules: {
			...
			// See the note on `runtimeHelpers`.
