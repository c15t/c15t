...
- feat(core): add Google Tag Manager support by [@BurnedChris](https://github.com/BurnedChris) in [#283](https://github.com/inthhq/c15t/pull/283)
- fix(react): allow `trapFocus={false}` in `CookieBanner` by [@KayleeWilliams](https://github.com/KayleeWilliams) in [#291](https://github.com/inthhq/c15t/pull/291)
- fix(nextjs): improved URL validation by [@BurnedChris](https://github.com/BurnedChris) in [#284](https://github.com/inthhq/c15t/pull/284)
- Version Packages by [@github-actions](https://github.com/github-actions) in [#293](https://github.com/inthhq/c15t/pull/293)

Published via commit [b4d53be](https://github.com/inthhq/c15t/commit/b4d53be) by [@github-actions](https://github.com/github-actions)

**Full Changelog**: [c15t@1.3.2...c15t@1.3.3](https://github.com/inthhq/c15t/compare/c15t@1.3.2...c15t@1.3.3)
