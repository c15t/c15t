...
- [#697](https://github.com/inthhq/c15t/pull/697) — fix RC theming regressions, clean up Tailwind setup guidance, and add the CSS matrix harness
- [#699](https://github.com/inthhq/c15t/pull/699) — clarify the customization ladder across AI agent docs, React/Next.js guides, and component examples
