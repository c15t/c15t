...
As part of 2.0's release we have upgraded the infrastructure used by customers on `inth.com`. This has many benefits such as being faster & improved bot detection, so your usage requests are more accurate to the human-visitors.
