...
- [#672](https://github.com/inthhq/c15t/pull/672) — tree-shake translations and Valibot from the client bundle
- [#668](https://github.com/inthhq/c15t/pull/668) — extract IAB support into `@c15t/iab`
- [#674](https://github.com/inthhq/c15t/pull/674) — support `primaryActions` arrays in policies
- [#670](https://github.com/inthhq/c15t/pull/670) — update Zustand, TypeScript 6, benchmarks, docs, and related RC/toolchain work
