...
- [#222](https://github.com/inthhq/c15t/issues/222) — duplicate/overlapping translation keys between dialog and widget (resolved by consolidation to `common`)
- [#217](https://github.com/inthhq/c15t/issues/217) / [#218](https://github.com/inthhq/c15t/issues/218) — Tailwind v3 `@layer base` collision (fixed by removing layer wrappers)

## ✨ What's Changed

- refactor(api): switch to oRPC and unified contract routing by [@BurnedChris](https://github.com/BurnedChris) in [#213](https://github.com/inthhq/c15t/pull/213)
- feat(sdk): introduce Node.js client with OpenAPI support by [@BurnedChris](https://github.com/BurnedChris) in [#214](https://github.com/inthhq/c15t/pull/214)
- fix(styles): remove Tailwind layer to avoid collision by [@KayleeWilliams](https://github.com/KayleeWilliams) in [#217](https://github.com/inthhq/c15t/pull/217)
- refactor(translations): consolidate into common + remove widget keys by [@KayleeWilliams](https://github.com/KayleeWilliams) in [#219](https://github.com/inthhq/c15t/pull/219)
- fix(schema): improve `setConsent` validation by [@KayleeWilliams](https://github.com/KayleeWilliams)
- Version Packages by [@github-actions](https://github.com/github-actions) in [#220](https://github.com/inthhq/c15t/pull/220)

Published via commit [f82e56a](https://github.com/inthhq/c15t/commit/f82e56a) by [@github-actions](https://github.com/github-actions)

**Full Changelog**: [c15t@1.2.0...c15t@1.2.1](https://github.com/inthhq/c15t/compare/c15t@1.2.0...c15t@1.2.1)
