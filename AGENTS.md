...
| --- | --- | --- |
| `AGENTS.md` + `docs/` in packages core, react, nextjs, tanstack-start, backend, scripts, cli | `scripts/generate-package-docs.ts` (leadtype — see the `leadtype` skill), runs during those packages' builds | `docs/**/*.mdx` + `docs/docs.config.ts` |
