...
import type { TableDefinition } from '~/pkgs/data-model/schema/types';
import type { C15TOptions } from '~/types';

// Import directly from original locations
import { getAuditLogTable } from '~/db/schema/audit-log';
import { getConsentTable } from '~/db/schema/consent';
import { getConsentGeoLocationTable } from '~/db/schema/consent-geo-location';
import { getConsentPolicyTable } from '~/db/schema/consent-policy';
import { getPurposeTable } from '~/db/schema/consent-purpose';
import { getPurposeJunctionTable } from '~/db/schema/consent-purpose-junction';
import { getConsentRecordTable } from '~/db/schema/consent-record';
import { getConsentWithdrawalTable } from '~/db/schema/consent-withdrawal';
import { getDomainTable } from '~/db/schema/domain';
import { getGeoLocationTable } from '~/db/schema/geo-location';
import { getSubjectTable } from '~/db/schema/subject';

import type { InferTableShape, TableName } from '~/db/schema/schemas';
