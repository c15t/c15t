...
import type { EntityTypeMap } from '~/pkgs/data-model/schema/types';
import type { Database as KyselyDatabase } from '~/pkgs/db-adapters/adapters/kysely-adapter/types';
import { AdapterInstance } from '~/pkgs/db-adapters/types';
