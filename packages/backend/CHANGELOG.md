...
- 3e2448f: feat: Add edge-compatible `/init` handler for running consent policy resolution at the edge
...
- 3e2448f: refactor(backend): flatten backend API entrypoints and improve TypeScript DX
...
- 3e2448f: feat(backend): add base '/' root endpoint for better DX
