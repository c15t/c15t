 ...
 * @internal
 */
export const createInitialIABState = function createInitialIABState(
	config: IABConfig
): IABState {
	return {
		cmpApi: null,
 ...
 */
const buildAllPurposeConsents = function buildAllPurposeConsents(
 ...
 */
const buildAllVendorConsents = function buildAllVendorConsents(
	gvl: GlobalVendorList,
 ...
 */
const buildAllSpecialFeatureOptIns = function buildAllSpecialFeatureOptIns(
	gvl: GlobalVendorList,
	value: boolean
 ...
 * @internal
 */
export const createIABManager = function createIABManager(
	config: IABConfig,
	getState: () => ConsentStoreState,
	setState: (partial: Partial<ConsentStoreState>) => void,
	manager: ConsentManagerInterface
