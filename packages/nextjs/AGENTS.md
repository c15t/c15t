...
- [ConsentBoundary](./docs/frameworks/next/components/consent-manager-provider.md): The Next.js boundary that hydrates a request-scoped consent kernel.
...
- [Server-Side Initialization](./docs/frameworks/next/server-side.md): Hydrate a request-scoped consent kernel in Next.js Server Components.
