...
Complete your [framework quickstart](../frameworks/index.md) first. Keep its Inth
...
`ConsentRoot`. Keep the server loader from the [TanStack Start quickstart](../frameworks/tanstack-start/quickstart.md).
...
in another loader. See the [Nuxt quickstart](../frameworks/nuxt/quickstart.md).
...
[Vue quickstart](../frameworks/vue/quickstart.md).
...
Retain the styles and consent UI from the [Svelte quickstart](../frameworks/svelte/quickstart.md).
...
and its serializable prefetch data from the [SvelteKit quickstart](../frameworks/sveltekit/quickstart.md).
