...
- [Quickstart](./docs/frameworks/tanstack-start/quickstart.md): Add consent management to your TanStack Start app with an SSR-hydrated first paint.
- [Server-Side Data Fetching](./docs/frameworks/tanstack-start/server-side.md): Resolve consent on the server in TanStack Start with prefetchInitialConsent, same-origin consent routes, and prerender-safe fallbacks.
