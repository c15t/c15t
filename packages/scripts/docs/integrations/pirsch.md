...
|:--|:--|:--|:--|:--:|
|identificationCode|string|Your Pirsch identification code.|-|✅ Required|
|domain|string \|string\[] \|undefined|Additional dashboard domains, optionally including per-domain codes.&#xA;&#xA;Arrays are serialized as Pirsch's comma-separated \`data-domain\` value.|-|Optional|
|dev|string \|undefined|Enable localhost testing by rewriting the tracked hostname.|-|Optional|
|hitEndpoint|string \|undefined|Custom pageview endpoint.|-|Optional|
|eventEndpoint|string \|undefined|Custom event endpoint.|-|Optional|
|disablePageViews|boolean \|undefined|Disable automatic pageview tracking.|-|Optional|
|extended|boolean \|undefined|Load Pirsch's extended script variant.|-|Optional|
