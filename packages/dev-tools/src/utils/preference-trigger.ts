 ...
 */
export const detectPreferenceTrigger =
 ...
 */
export const getPreferenceTriggerElements =
 ...
 */
export const setPreferenceTriggerVisibility =
 ...
 */
export const getPreferenceCenterOpener = function getPreferenceCenterOpener(
	namespace = 'c15tStore'
): (() => void) | null {
 ...
 */
export const openPreferenceCenter = function openPreferenceCenter(
	namespace = 'c15tStore'
): boolean {
