 ...
 * @internal
 */
export const generateRandomScriptId =
	function generateRandomScriptId(): string {
		...
		if (typeof crypto !== 'undefined' && crypto.randomUUID) {
			...
			return crypto.randomUUID().replace(/-/gu, '').substring(0, 8);
		}
 ...
 * @internal
 */
export const getScriptElementId = function getScriptElementId(
	scriptId: string,
	anonymizeId: boolean,
 ...
 * @internal
 */
export const hasLoadedScript = function hasLoadedScript(src: string): boolean {
 ...
 * @internal
 */
export const getLoadedScript = function getLoadedScript(
	src: string
 ...
 * @internal
 */
export const setLoadedScript = function setLoadedScript(
	src: string,
 ...
 * @internal
 */
export const deleteLoadedScript = function deleteLoadedScript(
	src: string
): void {
 ...
 * @internal
 */
export const clearLoadedScripts = function clearLoadedScripts(): void {
	loadedScripts.clear();
};
 ...
 * @internal
 */
export const getLoadedScriptsSnapshot =
	function getLoadedScriptsSnapshot(): ReadonlyMap<
		string,
