 ...
 * @public
 */
export declare const IAB_PURPOSES: {
	/** Store and/or access information on a device */
	readonly STORE_ACCESS_INFO: 1;
	/** Use limited data to select advertising */
	readonly SELECT_BASIC_ADS: 2;
	/** Create profiles for personalised advertising */
	readonly CREATE_AD_PROFILE: 3;
	/** Use profiles to select personalised advertising */
	readonly SELECT_PERSONALISED_ADS: 4;
	/** Create profiles to personalise content */
	readonly CREATE_CONTENT_PROFILE: 5;
	/** Use profiles to select personalised content */
	readonly SELECT_PERSONALISED_CONTENT: 6;
	/** Measure advertising performance */
	readonly MEASURE_AD_PERFORMANCE: 7;
	/** Measure content performance */
	readonly MEASURE_CONTENT_PERFORMANCE: 8;
	/** Understand audiences through statistics or combinations of data */
	readonly MARKET_RESEARCH: 9;
	/** Develop and improve services */
	readonly PRODUCT_DEVELOPMENT: 10;
	/** Use limited data to select content */
	readonly SELECT_BASIC_CONTENT: 11;
};
/**
 ...
 * @public
 */
export declare const IAB_SPECIAL_FEATURES: {
	/** Use precise geolocation data */
	readonly PRECISE_GEOLOCATION: 1;
	/** Actively scan device characteristics for identification */
	readonly DEVICE_SCANNING: 2;
};
/**
 * IAB TCF Feature IDs.
 *
 * @public
 */
export declare const IAB_FEATURES: {
	/** Match and combine data from other data sources */
	readonly MATCH_COMBINE_DATA: 1;
	/** Link different devices */
	readonly LINK_DEVICES: 2;
	/** Identify devices based on information transmitted automatically */
	readonly IDENTIFY_DEVICES: 3;
};
/**
 ...
 * @public
 */
export declare const IAB_DATA_CATEGORIES: {
	/** IP addresses */
	readonly IP_ADDRESSES: 1;
	/** Device characteristics */
	readonly DEVICE_CHARACTERISTICS: 2;
	/** Device identifiers */
	readonly DEVICE_IDENTIFIERS: 3;
	/** Probabilistic identifiers */
	readonly PROBABILISTIC_IDENTIFIERS: 4;
	/** Authentication-derived identifiers */
	readonly AUTH_IDENTIFIERS: 5;
	/** Browsing and interaction data */
	readonly BROWSING_DATA: 6;
	/** User-provided data */
	readonly USER_PROVIDED_DATA: 7;
	/** Non-precise location data */
	readonly NON_PRECISE_LOCATION: 8;
	/** Precise location data */
	readonly PRECISE_LOCATION: 9;
	/** Users' profiles */
	readonly USER_PROFILES: 10;
	/** Privacy choices */
	readonly PRIVACY_CHOICES: 11;
};
