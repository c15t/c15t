 ...
 * @remarks
 * Key features:
 * - Provides an accessible modal interface for consent customisation
 * - Implements smooth enter/exit animations
 * - Manages proper focus handling
 * - Supports theme customisation
 ...
 * @public
 */
export const ConsentManagerDialog: FunctionComponent<
...
> = ({
	...
	return isMounted ? createPortal(dialogContentRoot, document.body) : null;
};
