...
export const handlers = [
	...
	http.get('https://gvl.inth.com*', ({ request }) => {
 ...
 */
export const nonIABRegionHandler = http.get('https://gvl.inth.com*', () => {
 ...
 */
export const errorHandler = http.get('https://gvl.inth.com*', () => {
 ...
 */
export const invalidGVLHandler = http.get('https://gvl.inth.com*', () => {
