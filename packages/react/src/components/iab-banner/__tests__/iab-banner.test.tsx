/**
 * IAB Banner Unit Tests
 *
 * Tests for IAB Banner component display and behavior.
 */
...
import { IABBanner } from '../iab-banner';
...
describe('IAB Banner Unit Tests', () => {
	beforeEach(() => {
	...
	describe('Props', () => {
		test('should accept primaryButton prop', async () => {
			render(
				<ConsentManagerProvider options={defaultIABOptions}>
					<IABBanner primaryButton="accept" />
				</ConsentManagerProvider>
			);
