...
/**
 * Shim file extension per supported export condition. The `svelte` and
 * `default` conditions target the same ESM files as `import` in the mirrored
 * packages (`@c15t/svelte` is ESM-only), so all three share the `.js` shim.
 */
