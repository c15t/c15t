...
/**
 * Zero-consent baseline-client page: identical app shell, NO c15t (the module is
 ...
 * component (they don't exist in the baseline-client build). The probe stub mirrors
...
<template>
	<main style="padding: 2rem; font-family: system-ui">
		<h1>Zero-consent baseline-client</h1>
