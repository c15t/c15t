...
/**
 * A stand-in tracking script gated on measurement consent. The harness
 * checks it never loads before a choice, including when the manifest fetch
 * fails on a cold cache.
 */
const scripts: NonNullable<ConsentProviderOptions['scripts']> = [
	{ category: 'measurement', id: 'bench-tracker', src: '/tracker.js' },
];
